...
<!--- <cfstoredproc procedure="FetchRatingsList" datasource="ows_oracle">
 <cfprocresult name="getRatings"> 
</cfstoredproc> --->

<cfstoredproc procedure="FetchRatingsList" datasource="ows_oracle">
  <!--- Passa um parâmetro de saída que será o cursor --->
  <cfprocparam type="output" cfsqltype="cf_sql_refcursor" variable="dadosClientes">
</cfstoredproc>
